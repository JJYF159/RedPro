...
window.addEventListener('DOMContentLoaded', function() {
    const btnIrCarrito = document.getElementById('sidebar-ir-carrito');
    if (btnIrCarrito) {
        btnIrCarrito.addEventListener('click', function(e) {
            e.preventDefault();
            // Verificar si el usuario está logueado
            const logueado = window.usuarioLogueado || false;
            if (!logueado) {
                // Mostrar mensaje y redirigir a inicio de sesión
                alert('Inicia sesión o regístrate para terminar esta compra');
    ...
    // Asegurar que el botón X (cerrar) funcione correctamente
